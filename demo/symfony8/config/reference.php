 ...
 * }
 * @psalm-type NowoSerialNumberConfig = array{
 *     mask_char?: scalar|Param|null, // Single character used to mask the serial number when using the Twig filter (e.g. "*") // Default: "*"
 *     mask_visible_last?: int|Param, // Default number of trailing characters to leave visible when masking (e.g. 4 for last 4 digits) // Default: 4
 * }
 ...
 *     twig?: TwigConfig,
 *     nowo_serial_number?: NowoSerialNumberConfig,
 *     "when@dev"?: array{
 *         imports?: ImportsConfig,
 *         parameters?: ParametersConfig,
 *         services?: ServicesConfig,
